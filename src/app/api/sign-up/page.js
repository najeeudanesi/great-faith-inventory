...
export default function Page () {
  ...
  return (
    <div className="centered-div w-full max-w-xs">
      ...
      <button className="primary-button btn-pad" onClick={signUp}> <div className="flex justify-center">
      <ArrowRightOnRectangleIcon className="icon"/>Sign up
        </div></button>
        <div className="flex justify-end mt-4"><div>{"Already have an account "} <a href="/" className="ml-4 text-pink-600 font-semibold">Sign in</a></div></div>
